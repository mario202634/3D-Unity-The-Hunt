...
public class AIController : MonoBehaviour
{
    ...
    public int health;
    public int damage;
    public float viewRadius = 50;                   //  Radius of the enemy view
    ...
    private void Chasing()
    {
        ...
        {
            if (m_WaitTime <= 0 && !m_CaughtPlayer && Vector3.Distance(transform.position, GameObject.FindGameObjectWithTag("Player").transform.position) >= 600f)
            {
    ...
    public void OnTriggerEnter(Collider other)
    {
        if (other.tag == "Player") // 
        {
           ...
           GetComponent<Animator>().SetTrigger("Fight");
